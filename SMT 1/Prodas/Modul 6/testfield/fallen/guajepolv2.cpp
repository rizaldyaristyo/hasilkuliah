...
int main(){
	...
	char regpasschk[panjangTabel],userString[panjangTabel],passString[panjangTabel],kodeString[7],kodeStringTemp[8],
	userName[besarTabel][panjangTabel],password[besarTabel][panjangTabel],kodeUser[besarTabel][8],userSave[panjangTabel],passSave[panjangTabel],
	...
	{case 1:
		...
		snprintf(kodeStringTemp, 7, "%s-%04d",kodeString,noUrut);
