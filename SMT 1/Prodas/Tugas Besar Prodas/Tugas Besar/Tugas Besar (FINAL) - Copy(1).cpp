...
int main()
{
	...
	system("cls");
	logo();
	printf("\n\t\t\t     ==Menu==\n\t\t\t 1.) Mabar sama COM Random\n\t\t\t 2.) Mabar sama COM Logic\n\t\t\t");
	printf(" 3.) Mabar sama Hooman\n\t\t\t 0.) EXID\n\n\t\t\t Pilihan: ");
	scanf("%d",&pilihan);
	switch(pilihan)
	{
	case 1:
	...
	{printf("\t\t\tSeri!"); getch(); goto reset;}
		...
		if(giliran==0){
			...
			if(terisi==1){
				...
				if	   (kotak[0]=='X'&&kotak[1]=='X') kotak[2]='O';
				else if(kotak[1]=='X'&&kotak[2]=='X') kotak[0]='O';
				else if(kotak[3]=='X'&&kotak[4]=='X') kotak[5]='O';
				else if(kotak[4]=='X'&&kotak[5]=='X') kotak[3]='O';
				else if(kotak[6]=='X'&&kotak[7]=='X') kotak[8]='O';
				else if(kotak[7]=='X'&&kotak[8]=='X') kotak[6]='O';
				else if(kotak[0]=='X'&&kotak[4]=='X') kotak[8]='O';
				else if(kotak[4]=='X'&&kotak[8]=='X') kotak[0]='O';
				else if(kotak[2]=='X'&&kotak[4]=='X') kotak[6]='O';
				else if(kotak[4]=='X'&&kotak[6]=='X') kotak[2]='O';
				else if(kotak[6]=='X'&&kotak[8]=='X') kotak[7]='O';
				else if(kotak[2]=='X'&&kotak[8]=='X') kotak[5]='O';
				else if(kotak[0]=='X'&&kotak[6]=='X') kotak[3]='O';
				else if(kotak[0]=='X'&&kotak[2]=='X') kotak[1]='O';
				else if(kotak[3]=='X'&&kotak[6]=='X') kotak[4]='O';
				else if(kotak[0]=='X'&&kotak[8]=='X') kotak[4]='O';
				else if(kotak[0]=='X'&&kotak[3]=='X') kotak[6]='O';
				else if(kotak[3]=='X'&&kotak[6]=='X') kotak[0]='O';
				else if(kotak[1]=='X'&&kotak[4]=='X') kotak[7]='O';
				else if(kotak[4]=='X'&&kotak[7]=='X') kotak[1]='O';
				else if(kotak[2]=='X'&&kotak[5]=='X') kotak[8]='O';
				else if(kotak[5]=='X'&&kotak[8]=='X') kotak[2]='O';
				else {printf("error at var terisi 3");getch();}
			}
			else if(terisi==5){
				if	   (kotak[0]=='X'&&kotak[1]=='X'&&kotak[2]=='2') kotak[2]='O';
				...
				else if(kotak[0]=='O'&&kotak[1]=='O'&&kotak[2]=='2') kotak[2]='O';
